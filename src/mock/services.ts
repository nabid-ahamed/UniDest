...
const seedRequests: ServiceRequest[] = [
  { id: 559357, dateCreated: '10-06-2026', status: '', studentName: 'TRETET GDGD', studentEmail: 'hghgh@gmail.com', studentPhone: '+880 1999 999990', service: 'Visa On Time', country: 'Canada', description: 'Voluptas ullam rerum quis, bibendum mollis mauris integer in faucibus.', assignedTo: null, notes: '', messages: [], activity: [] },
  { id: 820610, dateCreated: '17-05-2026', status: '', studentName: 'Manan Parekh', studentEmail: 'manan.parekh@gmail.com', studentPhone: '+880 1880 011223', service: 'Insurance', country: 'Malta', description: '', assignedTo: null, notes: '', messages: [], activity: [] },
  { id: 637180, dateCreated: '12-05-2026', status: '', studentName: 'Manan Parekh', studentEmail: 'manan.parekh@gmail.com', studentPhone: '+880 1880 011223', service: 'Work Visa', country: 'United Arab Emirates', description: 'Ok, Hello. Need this processed before July.', assignedTo: 'Admin Two Test', notes: '', messages: [], activity: [] },
  ...
  { id: 163454, dateCreated: '06-05-2026', status: '', studentName: 'jasp as', studentEmail: 'jasp.as@gmail.com', studentPhone: '+880 1900 012121', service: 'Visitor Visa', country: 'Canada', description: '', assignedTo: null, notes: '', messages: [], activity: [] },
  ...
  { id: 105263, dateCreated: '04-01-2026', status: '', studentName: 'Priya Nair', studentEmail: 'priya.nair@gmail.com', studentPhone: '+880 1900 001111', service: 'Insurance', country: 'United Kingdom', description: '', assignedTo: null, notes: '', messages: [], activity: [] },
]
